...
module.exports.MemProfiler = require './src/MemProfiler'
module.exports.Supervisor = require './src/Supervisor'
...
module.exports.Connectors.ElasticSearch = require './src/connectors/ElasticSearch'
