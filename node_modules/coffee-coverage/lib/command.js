...
(function() {
  var CoverageInstrumentor, fs, mkdirs, parseArgs, path, printHelp, ref, ref1, stripLeadingDotOrSlash, version;
  ...
  ref = require('./coffeeCoverage'), CoverageInstrumentor = ref.CoverageInstrumentor, version = ref.version;

  ref1 = require('./helpers'), stripLeadingDotOrSlash = ref1.stripLeadingDotOrSlash, mkdirs = ref1.mkdirs;
