...
describe('[platform] osx async apis', function() {

    it ('[method] virtualMemory', function(done) {
    ...
    it ('[method] swapMemory', function(done) {
        ns.swapMemory(function(err, res) {
            console.log(res);
            assert.equal(res.total, res.used + res.free);
            done();
        });
    });

    it ('[method] cpuTimes & perCpuTime', function(done) {
    ...
    it ('[method] perCpuTimes', function(done) {
    ...
    it ('[method] cpuCountLogical', function(done) {
    ...
    it ('[method] cpuCountPhys', function(done) {
        ns.cpuCountPhysical(function(err, res) {
            console.log(res);
            done();
        });
    })

    it ('[method] bootTime', function(done) {
    ...
    it ('[method] diskPartitions', function(done) {
